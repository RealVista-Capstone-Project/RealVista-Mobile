...
import { BORDER_RADIUS, CORNERS, FONT_SIZE } from '@/shared/theme/globals'
import { BottomSheet, useBottomSheet } from '@/shared/ui/bna/bottom-sheet'
import { Button } from '@/shared/ui/bna/button'
import { Icon } from '@/shared/ui/bna/icon'
import { ScrollView } from '@/shared/ui/bna/scroll-view'
...
export function DatePicker(props: DatePickerProps) {
  ...
  const mutedColor = useColor('purple96') // #F0EFFB
  ...
  return (
    <>
      <TouchableOpacity
        ...
        disabled={disabled}
      >
        {/* Left side: Icon and label/value */}
        <View
          style={{
            flexDirection: 'row',
            alignItems: 'center',
        ...
        >
          {mode === 'time' ? (
            <Icon name={Clock} size={24} strokeWidth={1.5} />
          ) : mode === 'datetime' ? (
            <Icon name={CalendarClock} size={24} strokeWidth={1.5} />
          ) : mode === 'range' ? (
            <Icon name={CalendarRange} size={24} strokeWidth={1.5} />
          ) : (
