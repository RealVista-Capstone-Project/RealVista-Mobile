...
const darkColors = {
  ...
  // ========== FIGMA DESIGN COLORS ==========
  // Main Colors (same in both light and dark mode for consistency)
  mainBlack: '#000929',
  mainWhite: '#FFFFFF',
  mainPrimary: '#7065F0',
  mainSecondary: '#100A55',

  // Shades of Purple (same in both light and dark mode for consistency)
  purple98: '#F7F7FD',
  purple96: '#F0EFFB',
  purple94: '#E8E6F9',
  purple92: '#E0DEF7',
  ...
  // Greyscale (same in both light and dark mode for consistency)
  grey50: '#F9FAFB',
  grey100: '#F4F4F6',
  grey200: '#E5E6EB',
  grey300: '#D3D5DA',
